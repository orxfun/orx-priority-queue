...
//!
//! This allows to use all the queue implementations interchangeably and conveniently measure performance. See <a href="#section-benchmarks">C. Benchmarks</a> section to see the results.
//!
...
//! ```
//!
//! ### B.2. Usage in Dijkstra's Shortest Path
//!
